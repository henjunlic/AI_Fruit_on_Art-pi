...
#define AI_FRUIT_IN_1_SIZE  (64 * 64 * 3)
#define AI_FRUIT_IN_1_SIZE_BYTES  ((64 * 64 * 3) * 1)
...
#define AI_FRUIT_OUT_1_SIZE  (1 * 1 * 7)
#define AI_FRUIT_OUT_1_SIZE_BYTES  ((1 * 1 * 7) * 1)

#define AI_FRUIT_N_NODES (10)
